...
#define ARM9_BOOT 0
#define ARM9_INIT 1
#define ARM9_MBKSET 2
#define ARM9_CARDENGINE 3
#define ARM9_START 4
#define ARM9_MEMCLR 5
#define ARM9_READY 6
#define ARM9_BOOTBIN 7
#define ARM9_DISPERR 8
...
static inline void copyLoop (void* destvoid, const void* srcvoid, size_t size) {
	u32* dest = (u32*)destvoid;
	u32* src = (u32*)srcvoid;
	do {
		*dest++ = *src++;
	} while (size -= 4);
